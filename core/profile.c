...
void create_plot_info_new(struct dive *dive, struct divecomputer *dc, struct plot_info *pi, bool fast)
{
	...
	struct deco_state *ds = &plot_deco_state;
	init_decompression(ds, dive);
#endif
...
#ifndef SUBSURFACE_MOBILE
	calculate_deco_information(ds, dive, dc, pi, false); /* and ceiling information, using gradient factor values in Preferences) */
#endif
